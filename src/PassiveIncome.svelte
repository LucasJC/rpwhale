    ...
    {#if $miningPower}
      ...
      <div class="columns">
        ...
        <div class="column">
          <p
            class="subtitle has-text-centered"
            data-tooltip="Wax calculated income. Defaults to 0 when prices are not available."
          >
            Wax
          </p>
          <table
        ...
        <div class="column">
          <p
            class="subtitle has-text-centered"
            data-tooltip="USD calculated income. Defaults to 0 when prices are not available."
          >
            USD
          </p>
          <table
